...
public class AlgoKMeans {
	 ...
	 */
	public List<Cluster> runAlgorithm(Map<DTNHost, Double> centrality, int k) throws NumberFormatException, IOException {
		...
		for ( DTNHost h: centrality.keySet()) {
			
			double [] vector = new double[1]; 
			
				double value = centrality.get(h);
	 ...
	 */
	public List<Cluster> saveToFile(String output) throws IOException {
